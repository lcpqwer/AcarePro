<template>
	<view class="all" :style="allHeight">
		...
		<scroll-view style="width: 100%;height: 100%;" scroll-y="true" >
			<image style="width: 100%;" src="/static/img/top/境內高鐵接送.png" mode="widthFix"></image>
		<view class="Sname">
			我的订单
		</view>
				...
				<view class="Order-img">
					<!-- <view class="OI-img-warpper">
						<view style="width: 100%;height: 100%;">
							<image src="/static/img/server/Artboard%2010.png" class="OI-img" mode="aspectFill"></image>
						</view>
					</view> -->
					<image :src="qrcode" class="OI-img" mode="widthFix"></image>
				</view>
				<view class="Order-info">服务日期：{{OrderItem.YMD}}</view>
				<view class="Order-info">高铁站：{{OrderItem.order_detail.HSRStation}}</view>
				<view class="Order-info">车次信息：{{OrderItem.order_detail.HSRInfo}}</view>
				<view class="Order-info" v-if="OrderItem.order_detail.Type == 0">目的地：{{OrderItem.order_detail.Address}}</view>
				<view class="Order-info" v-else>起始地：{{OrderItem.order_detail.Address}}</view>
