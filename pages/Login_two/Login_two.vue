<template>
	<view class="all-warpper" style="background-image: url('/static/img/LoginBack.png');background-size: 100% 100%;">
		<!-- <view class="LoginMain"> -->
			<view class="Logo">
				<image src="/static/img/logo/guoren.png" mode="aspectFit" class="Logo-img"></image>
			...
			<view class="Input-warpper" style="z-index: 10">
				...
				<view class="Input" style="border: #C0C0C0 solid 1upx;">
					<text class="Input-text">车架号&ensp;：</text><input class="Input-input" :value="CarCodes" @input="changCarCodes" type="text" placeholder="请输入车架号后六位" placeholder-style="color: #cccccc">
				</view>
			</view>
			<button class="Sub" type="primary" @tap="Login" style="z-index: 10;background-color: #4db8e9;color: #fff;box-shadow: 5upx 5upx 5upx #888888;">登&emsp;陆</button>
			<!-- <view></view> -->
...
<script>
	...
	export default {
		...
		methods:{
			...
			Login(){
				// 第一次登陆\token无效\清缓存之后
				let url = getApp().globalData.AllUrl+'auth/user/login'
				let that = this
...
<style lang="scss">
	...
	.Input {
		height: 90upx;width: 100%;position: relative;z-index: 10;background-color: #fff;
