		...
		<view class="Main MainTop">
			...
			<view class="Main-main">
				...
				<view class="Order-state">
					<view style="position: absolute;top: 50%;left: 50%;transform: translate(-50%,-50%);display: flex;flex-direction: row;">
				...
				<view class="Order-img">
					...
					<!-- <view class="OI-img-warpper">
						<view style="width: 100%;height: 100%;">
							<image src="/static/img/server/Artboard%2012.png" class="OI-img" mode="aspectFill"></image>
						</view>
					</view> -->
				</view>
