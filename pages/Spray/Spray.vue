<template>
	<view class="all">
		<scroll-view style="width: 100%;height: 100%;" scroll-y="true" >
			<image style="width: 100%;" src="/static/img/top/噴漆.png" mode="widthFix"></image>
			<view class="Sname">喷 漆</view>
			<view class="Main">
				...
				<scroll-view @scrolltolower="lower" scroll-y="true" class="Main-bottom">
					<view class="Main-bottom-item" v-for="(item,index) in storesInfo" :key="index" style="position: relative;" @tap="showModel2(item)">
						...
						uni.request({
							...
							success: res => {
								...
								if (res.data.msg == "暂无未处理订单"){
									...
									this.Prompt('你有未处理的车享家喷漆订单,请选择非车享家的店铺')
									this.model = false
									this.model2 = false
								}
							},
...
<style lang="scss">
	// .Sname {
	// 	width: 50%;height: 70upx;background: linear-gradient(to right, #808080, rgba(255,255,255,0));position: fixed;top: 15%;font-size: 45upx;text-indent: 80upx;color: white;
	// }
	...
	.Main {
		// width: 100%;height: 78vh;position: fixed;top: 22vh;border-top: #c0c0c0 solid 4upx;background-color: #fff;border-top-left-radius: 8vh 6vh;border-top-right-radius: 8vh 6vh;
		height: 84vh;
		position: absolute;
		top: 220upx;
		&-top {
			width: 100%;height: 6vh;font-size: 2vh;text-align: center;line-height: 6vh;
		}
		&-map {
			width: 39vh;height: 22vh;margin-left: 50%;transform: translateX(-50%);border: #c0c0c0 solid 4upx;
		}
		&-bottom {
			width: 100%;height: 52vh;position: absolute;bottom: 0;overflow-y: auto;
			
			&-item {
				width: 650upx;height: 210upx;padding-left: 50upx;padding-right: 50upx;
				
				&-warpper {
					width: 100%;height: 160upx;padding-top: 25upx;padding-bottom: 25upx;border-bottom: #c0c0c0 solid 2px;
					
					&-img {
						height: 100%;width: 200upx;display: inline-block;margin-right: 30upx;vertical-align: middle;
					}
	...
	.Text-warpper {
		...
		&-item {
			width: 100%;height: 20%;font-size: 20upx;line-height: 32upx;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;
		}
	}
	...
	// 模态框
	.Model {
		width: 100%;height: 100%;background-color: rgba(220,220,220,0.5);position: fixed;top: 0;
		
		&-main {
			width: 545upx;background-color: #fff;position: fixed;top: 27vh;left: 50%;transform: translateX(-50%);border-radius: 20upx;border: #c0c0c0 solid 3upx;
			
			&-top {
				width: 100%;height: 8vh;position: relative;
				
				&-img {
					width: 3vh;height: 3vh;position: absolute;top: 50%;transform: translate(50%,-50%);right: 60upx;
				}
				&-hide {
					height: 80%;width: 4vh;background-color: rgba(255,255,255,0);position: absolute;top: 50%;transform: translate(50%,-50%);right: 60upx;
				}
			}
			&-qrcode {
				height: 20vh;width: 20vh;margin-left: 50%;transform: translateX(-50%);padding-top: 2vh;padding-bottom: 2vh;
			}
			&-text {
				width: 100%;text-align: center;height: 3vh;line-height: 3vh;font-size: 2vh;
			}
			&-sub {
				height: 5vh;width: 80%;line-height: 5vh;font-size: 2vh;margin-top: 5vh;background-color: #3b8bff;margin-bottom: 5vh;
			}
		}
	}
</style>
