		...
		<view class="Main MainTop">
			...
			<view class="Main-main">
				...
				<view v-if="OrderItem.order_detail.Type == 0">
					<view class="Order-info">机场：{{OrderItem.order_detail.Station}}</view>
					<view class="Order-info">航班号：{{OrderItem.order_detail.FlightNo}}</view>
				</view>
				<view v-else>
					<view class="Order-info">高铁站：{{OrderItem.order_detail.Station}}</view>
					<view class="Order-info">车次信息：{{OrderItem.order_detail.FlightNo}}</view>
				</view>
				<view class="Order-info">客票号：{{OrderItem.order_detail.TicketNo}}</view>
				<view class="Order-info">服务时间：{{OrderItem.HM}}</view>
				<view class="Order-info">贵宾厅：{{OrderItem.order_detail.VIPRoom}}</view>
